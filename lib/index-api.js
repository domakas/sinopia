      ...
      packages.map(function(package) {
        ...
        for (var prop in package.versions) {
          if(!package.hasOwnProperty(prop)) {
            versions[prop] = {
              name: package.versions[prop].name,
              version: package.versions[prop].version,
              dist: {
                url: package.versions[prop].dist.tarball.replace('http://', 'https://'),
                type: 'tar',
                shasum: package.versions[prop].dist.shasum
              }
            }
          }
        }
